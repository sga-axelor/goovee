...
function RoundButton({ children, onClick, disabled, active ,className="", ...rest }: any) {
  return (
    <Button
      variant="outline"
      size="sm"
...
export function Pagination({
  ...
  return (
    <div className="flex items-center gap-1 flex-wrap">
      <RoundButton onClick={onPrev} disabled={disablePrev} className="p-2 bg-transparent border-0">
        <div className="flex">
      ...
      <RoundButton onClick={onNext} disabled={disableNext} className="p-2 bg-transparent border-0">
        <div className="flex">
