  ...
  'relative w-full rounded-lg border p-4 [&>svg~*]:pl-7 [&>svg+div]:translate-y-[-0.1875rem] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:text-foreground',
  {
    variants: {
      variant: {
        ...
        destructive:
          'border-destructive/50 text-destructive dark:border-destructive bg-destructive-light [&>svg]:text-destructive',
        success:
        ...
        primary:
          'border-palette-blue-dark text-palette-blue-dark bg-palette-blue [&>svg]:text-blue-dark',
      },
    },
    defaultVariants: {
      variant: 'default',
