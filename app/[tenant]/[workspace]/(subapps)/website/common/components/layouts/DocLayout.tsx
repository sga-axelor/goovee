...
// -------- custom component -------- //
import {Navbar} from '@/subapps/website/common/components/blocks/navbar';
import PageProgress from '@/subapps/website/common/components/common/PageProgress';
import NextLink from '@/subapps/website/common/components/reuseable/links/NextLink';
import useClipboard from '@/subapps/website/common/hooks/useClipboard';
// -------- data -------- //
const navigations = [
  {
    title: 'Usage',
          ...
          <div className="row">
            <div className="col-xl-9 mx-auto">
              <h2 className="display-3 text-white mt-3 mb-3 px-lg-8">
                Think unique and be creative. Make a difference with Lighthouse.
              </h2>

              <p className="lead fs-lg mb-6 px-lg-15">
