...
// -------- data -------- //
import {processList7} from '@/subapps/website/common/data/process';
  ...
  return (
    <div className="row gx-lg-8 gx-xl-12 gy-10 mb-14 mb-md-16 align-items-center">
      ...
      <div className="col-lg-5">
        ...
        {processList7.map(({id, title, description}, i) => {
          ...
          return (
            <div
              ...
              key={id}>
              <div>
                <span className="icon btn btn-sm btn-soft-primary pe-none me-5">
                  <span className="number fs-16">{i + 1}</span>
                </span>
              </div>
