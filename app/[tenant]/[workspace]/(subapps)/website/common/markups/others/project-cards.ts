const card1Markup = `import { ProjectCard1 } from '@/subapps/website/common/components/reuseable/project-cards';
...
const card2Markup = `import { ProjectCard2 } from '@/subapps/website/common/components/reuseable/project-cards';
...
const card3Markup = `import { ProjectCard3 } from '@/subapps/website/common/components/reuseable/project-cards';
