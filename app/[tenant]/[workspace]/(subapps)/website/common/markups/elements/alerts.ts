const simpleMarkup = `<div className="alert alert-primary alert-icon" role="alert">
...
const dismissalMarkup = `<div className="alert alert-primary alert-icon alert-dismissible fade show" role="alert">
  <i className="uil uil-star" /> A simple primary alert with{' '}
  <a href="#" className="alert-link hover"> an example link </a>
...
export {simpleMarkup, dismissalMarkup};
