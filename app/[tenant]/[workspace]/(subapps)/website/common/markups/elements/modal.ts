...
const signinMarkup = `import Signin from '@/subapps/website/common/components/blocks/navbar/partials/Signin';
...
const signupMarkup = `import Signup from '@/subapps/website/common/components/blocks/navbar/partials/Signup';
