...
export default function Footer5(props: TemplateProps<Footer5Data>) {
  const {data} = props;
  const {
    footer5Logo,
    footer5Copyright: copyright,
    footer5AddressTitle: addressTitle,
    footer5AddressLine: addressLine,
    footer5Email: email,
    footer5Phone: phone,
    footer5LinkTitle: linkTitle,
    footer5NewsletterTitle: newsletterTitle,
  ...
  const socialLinks =
    footer5SocialLinks?.map(socialLink => ({
      id: socialLink.id,
