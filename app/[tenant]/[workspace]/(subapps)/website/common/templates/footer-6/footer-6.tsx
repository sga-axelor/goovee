...
import {type Footer6Data} from './meta';
import {getMetaFileURL} from '@/subapps/website/common/utils/helper';
import SocialLinks from '@/subapps/website/common/components/reuseable/SocialLinks';
import NextLink from '@/subapps/website/common/components/reuseable/links/NextLink';

export function Footer6(props: TemplateProps<Footer6Data>) {
  const {data} = props;
  const {
    footer6Logo,
    footer6Copyright: copyright,
    footer6AddressTitle: addressTitle,
    footer6AddressLine: addressLine,
    footer6Email: email,
    footer6Phone: phone,
    footer6LinkTitle: linkTitle,
    footer6NewsletterTitle: newsletterTitle,
    footer6NewsletterDescription: newsletterDescription,
    footer6Links: links,
    footer6SocialLinks,
    footer6FooterClassName: footerClassName,
    footer6ContainerClassName: containerClassName,
  } = data || {};

  const logo = getMetaFileURL({
    metaFile: footer6Logo,
    path: 'footer6Logo',
    ...props,
  });
