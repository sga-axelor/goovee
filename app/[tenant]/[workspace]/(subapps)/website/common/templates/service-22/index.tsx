...
export default function Service22(props: TemplateProps<Service22Data>) {
  const {data} = props;
  const {
    service22Caption: caption,
    service22Title: title,
    service22Tabs: tabs,
    service22WrapperClassName: wrapperClassName,
    service22ContainerClassName: containerClassName,
  } = data || {};
