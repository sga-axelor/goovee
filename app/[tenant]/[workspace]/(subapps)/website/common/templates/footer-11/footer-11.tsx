...
export function Footer11(props: TemplateProps<Footer11Data>) {
  const {data} = props;
  const {
    footer11Logo,
    footer11Copyright: copyright,
    footer11AddressTitle: addressTitle,
    footer11AddressLine: addressLine,
    footer11Email: email,
    footer11Phone: phone,
    footer11ListTitle: listTitle,
    footer11NewsletterTitle: newsletterTitle,
    footer11NewsletterDescription: newsletterDescription,
    footer11Links: links,
    footer11SocialLinks,
    footer11FooterClassName: footerClassName,
    footer11ContainerClassName: containerClassName,
  } = data || {};

  const logo = getMetaFileURL({
    metaFile: footer11Logo,
    path: 'footer11Logo',
    ...props,
  });
    ...
    <footer className={footerClassName} data-code={props.code}>
      <div className={containerClassName}>
        <div className="row gy-6 gy-lg-0">
          ...
          <div className="col-md-4 col-lg-3">
            <div className="widget">
              <h4 className="widget-title mb-3">{listTitle}</h4>
