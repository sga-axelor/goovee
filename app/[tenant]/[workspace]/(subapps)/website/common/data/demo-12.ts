import Box from '@/subapps/website/common/icons/solid/Box';
import User from '@/subapps/website/common/icons/lineal/User';
import Check from '@/subapps/website/common/icons/lineal/Check';
import {LinkType} from '@/subapps/website/common/types/demo-1';
import IdCard from '@/subapps/website/common/icons/solid/IdCard';
import ThumbsUp from '@/subapps/website/common/icons/solid/ThumbsUp';
import Megaphone from '@/subapps/website/common/icons/solid/Megaphone';
import BriefcaseTwo from '@/subapps/website/common/icons/lineal/BriefcaseTwo';
