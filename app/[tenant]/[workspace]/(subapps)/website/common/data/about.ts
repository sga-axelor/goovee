// -------- icons -------- //
import Lamp from '@/subapps/website/common/icons/solid-mono/Lamp';
import Bulb from '@/subapps/website/common/icons/solid-mono/Bulb';
import Puzzle from '@/subapps/website/common/icons/solid-mono/Puzzle';
import Headphone from '@/subapps/website/common/icons/solid-mono/Headphone';
...
export const aboutList1 = [
  [
    'We offer stress-free spending control.',
    'We offer stress-free spending control.',
  ],
  [
    'We offer stress-free spending control.',
...
export const aboutList5 = [
  [
    'We are a firm that understands the impact',
    'We are a firm that understands the impact',
  ],
  [
    'We are a firm that understands the impact',
