    ...
    <>
      <div className="flex flex-col gap-4">
        ...
        <div className="hidden lg:block">
          <StyledTable headStyle='bg-primary !text-white !rounded-none !text-sm !px-4' columns={PRODUCT_COLUMNS}>
        ...
        <div className="block lg:hidden">
          <StyledTable headStyle='bg-primary !text-white !rounded-none !text-sm !px-4' columns={PRODUCT_CARD_COLUMNS}>
            {saleOrderLineList?.map((product: any) => {
