...
import Design from '@/subapps/templates/common/icons/solid/Design';
            ...
            <div className="row position-relative">
              <div className="col-lg-8 col-xxl-7 mx-auto position-relative">
                ...
                <div data-cues="slideInDown" data-group="page-title">
                  <h1 className="display-1 fs-64 mb-5 mx-md-12 mx-lg-0 mx-xl-10">
                    Make an impressive and simple webpage
                    <br />
                    <span className="rotator-fade text-primary">
                      for your company.,your portfolio.,your startup.,digital
                      marketing.
                    </span>
                  </h1>

                  <p className="lead fs-24 mb-8 mx-lg-13">
                    Using Lighthouse myriad of wonderful features, you can
                    design a web page in moments.
                  </p>
                </div>
          ...
          <div className="container pt-16 pt-mb-18">
            <div className="row mb-10">
              <div className="col-lg-10 col-xl-7 mx-auto">
                ...
                <h2 className="display-2 mb-3 text-center mb-0">
                  Get started, effective, outstanding, and rich demonstration
                </h2>
              </div>
            </div>
            ...
            <div className="row mb-8 text-center">
              <div className="col-md-11 col-lg-10 col-xl-8 col-xxl-7 mx-auto">
                <h2 className="display-2 mt-3 mb-3 mb-0 px-lg-10 px-xl-0">
                  Use Lighthouse on your web page and save both time and cash.
                </h2>
              </div>
            </div>
            ...
            <div className="row gx-lg-0 gy-10 align-items-center mb-16 mb-md-18">
              ...
              <div className="col-lg-4 ms-auto">
                <div className="d-flex flex-row mb-6">
                  <div>
                    <div className="svg-bg bg-white rounded-xl shadow-xl me-5">
                      <Box className="solid text-primary" />
                    </div>
                  </div>

                  <div>
                    <h4 className="mb-1">Product Management</h4>
                    <p className="mb-0">
                ...
                <div className="d-flex flex-row mb-6">
                  <div>
                    <div className="svg-bg bg-white rounded-xl shadow-xl me-5">
                      <Design className="solid text-primary" />
                    </div>
                  </div>

                  <div>
                    <h4 className="mb-1">World-class Features</h4>
                    <p className="mb-0">
                ...
                <div className="d-flex flex-row">
                  <div>
                    <div className="svg-bg bg-white rounded-xl shadow-xl me-5">
                      <DevicesThree className="solid icon-svg-md text-primary" />
                    </div>
                  </div>

                  <div>
                    <h4 className="mb-1">Easy to customize</h4>
                    <p className="mb-0">
            ...
            <div className="row gx-lg-0 gy-10 align-items-center">
              ...
              <div className="col-lg-4 me-auto">
                <div className="d-flex flex-row mb-6">
                  <div>
                    <div className="svg-bg bg-white rounded-xl shadow-xl me-5">
                      <Code className="solid text-primary" />
                    </div>
                  </div>
                ...
                <div className="d-flex flex-row">
                  <div>
                    <div className="svg-bg bg-white rounded-xl shadow-xl me-5">
                      <DevicesTwo className="solid text-primary" />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="mb-0">
                      Adjusts to varying screen sizes, ensuring seamless
            ...
            <div className="row mb-8 text-center mt-17 mt-md-19 mb-9 mb-md-11">
              <div className="col-md-11 col-lg-10 col-xl-8 col-xxl-7 mx-auto">
                <h2 className="display-2 mb-0 px-lg-10 px-xl-0">
                  Make a web page with Lighthouse amazing functionality.
                </h2>
              </div>
            </div>
          </div>
                    ...
                    <div className="card shadow-xl rounded-xl">
                      <div className="card-body">
                        <blockquote className="icon mb-0">
                          <p>
                            “Lighthouse React is really attractive and it saves
                            my time. The support team is really amazing.”
                          </p>
                  ...
                  <div className="col-md-6 align-self-start">
                    <div className="card shadow-xl rounded-xl">
                      <div className="card-body">
                        <blockquote className="icon mb-0">
                          <p>
                            “Simply the best templates that I have bought so
                            far. Super clean code, intuitive documentations, and
              ...
              <div className="col-lg-10 col-xl-9 col-xxl-7 mx-auto">
                <div>
                  <img
                    ...
                    alt=""
                  />
                  <h1 className="display-2 fs-48 mt-5 mb-5">
                    Lighthouse allows you to be creative while making an effect.
                  </h1>
                  <p className="lead fs-22 mb-8 px-lg-12 px-xl-14 px-xxl-10">
                    Lots of customers have put their faith in us. Get us today
                    easily and rapidly design your amazing webpage.
                  </p>
                </div>
                ...
                <div className="d-flex justify-content-center">
                  <span>
                    <a
                      ...
                      className="btn btn-lg btn-primary btn-icon btn-icon-end rounded-xl"
                      target="_blank">
                      Buy Lighthouse <i className="uil uil-arrow-right" />
                    </a>
                  </span>
                </div>
              </div>
