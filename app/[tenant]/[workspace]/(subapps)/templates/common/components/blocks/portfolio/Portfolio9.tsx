          ...
          <div className="card-body p-12 pb-0">
            <div className="row">
              <div className="col-lg-4 pb-12 align-self-center">
                ...
                <h3 className="h1 post-title mb-3">Sandbox Real Estate</h3>
                <p>
                  Software engineers offer services related to software
                  development, web and mobile app development, DevOps, cloud
                  computing, database management, software testing, maintenance.
                </p>
                <NextLink
                  title="See Project"
                  href="#"
