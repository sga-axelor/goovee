...
import {Counter1} from '@/subapps/templates/common/components/reuseable/counter';
// -------- data -------- //
import {factList5} from '@/subapps/templates/common/data/facts';
  ...
  return (
    <div className="row gx-lg-8 gx-xl-12 gy-10 gy-lg-0 mb-11 align-items-end">
      <div className="col-lg-4">
        ...
        <h3 className="display-4 mb-0">We feel proud of our achievements.</h3>
      </div>
