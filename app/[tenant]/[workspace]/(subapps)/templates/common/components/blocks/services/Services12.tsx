      ...
      <div className="row">
        <div className="col-md-10 offset-md-1 col-lg-8 offset-lg-2 mx-auto text-center">
          ...
          <h3 className="display-4 mb-10 px-xl-10">
            Here are a small number of the reasons why our customers use
            Lighthouse.
          </h3>
        </div>
      </div>
      ...
      <ul
        ...
        <li className="nav-item" role="presentation">
          <a
            ...
            <div>
              <CheckShield className="solid icon-svg-md me-4" />
            </div>
        ...
        <li className="nav-item" role="presentation">
          <a
            ...
            <div>
              <Dollar className="solid icon-svg-md me-4" />
            </div>
        ...
        <li className="nav-item" role="presentation">
          <a
            ...
            className="nav-link d-flex flex-row">
            <div>
              <Update className="solid icon-svg-md me-4" />
            </div>
