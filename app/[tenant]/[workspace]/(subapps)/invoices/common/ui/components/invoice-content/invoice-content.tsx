  ...
  return (
    <>
      <div className="rounded-lg border shadow px-12 py-12 w-full overflow-x-auto overflow-y-hidden">
        <div className="min-w-[52.3125rem] lg:min-w-[100%] overflow-x-auto overflow-y-hidden">
          ...
          <div className="flex w-full gap-12 mb-6 pb-[4rem] border-b-[0.1875rem] border-solid border-palette-purple">
            <div className="flex-1">
              <h6 className="text-palette-purple-dark font-medium">
                {i18n.get('Billed To')}
              </h6>
